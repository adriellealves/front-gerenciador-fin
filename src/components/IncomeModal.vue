    ...
    <div class="modal-content">
      ...
      <form @submit.prevent="submitForm" class="expense-form">
        <div class="form-group">
          ...
          <input type="text" v-model="description" required placeholder="Ex: Salário..." />
        </div>
        ...
        <div class="form-group">
          ...
          <select v-model="accountId" required>
            <option value="" disabled>Selecione para onde o dinheiro entrou...</option>
...
.modal-header h2 { margin: 0; color: #2ed573; }
...
.btn-save:hover { background: #85f5b0; }
</style>